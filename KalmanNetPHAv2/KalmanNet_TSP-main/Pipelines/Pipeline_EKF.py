...
class Pipeline_EKF:
    ...
    def NNTrain(self, SysModel, cv_input, cv_target, train_input, train_target, path_results, \
        ...
        train_log_dir = './loss_train/2days2201x2'
        val_log_dir = './loss_val/2days2201x2'
        ...
        for ti in range(0, self.N_steps):
            ...
            train_summary_writer.add_scalar('Loss/train', self.MSE_train_linear_epoch[ti], ti)
            ...
            with torch.no_grad():
                ...
                val_summary_writer.add_scalar('Loss/val', self.MSE_cv_linear_epoch[ti], ti)
                ...
                if (self.MSE_cv_dB_epoch[ti] < self.MSE_cv_dB_opt):
                    ...
                    torch.save(self.model, path_results + self.modelName)
    ...
    def NNTest(self, SysModel, test_input, test_target, path_results, MaskOnState=False,\
     randomInit=False,test_init=None,load_model=False,load_model_path=None,\
        ...
        if load_model:
            ...
            self.model = torch.load(path_results+self.modelName, map_location=self.device)
